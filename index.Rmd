...
Exceptions to this are ggplot2's `aes()` and `vars()` functions which are always nested inside other ggplot2 
functions. We will use the import package to load those function as well as the `mpg` dataset:
