...
Create a basic scatter plot showing highway fuel efficiency vs city fuel efficiency. Add a Wall Street Journal theme from the ggthemes package; and colour the points based on the number of cylinders the car has.
...
Create a custom theme changing: major gridlines to blue; x axis font colour to red and y axis font colour to purple; move the legend position to the bottom of the plot.
...
Use the viridis scale to colour the lines for a black and white friendly printed version.
